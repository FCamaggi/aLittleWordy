...
export const CONSONANT_POOL = "LLLLNNNNNRRRRRSSSSSSTTTTDDDDDGGBBCCCCMMPPFFHHVYQJÑXZ";
...
export const CARDS: Card[] = [
  // --- VANILLA CARDS (Las 6 indicadas) ---
  {
    ...
    description: 'Construye una palabra. El oponente "apaga" (voltea) las letras que usaste que NO están en su palabra.',
    cost: 4,
    type: 'vanilla'
  },
  {
  ...
  },
  {
    ...
    description: 'Construye una palabra. Tu oponente dice si su palabra es más larga, corta o igual.',
    cost: 1,
    type: 'vanilla'
  },
  {
    ...
    description: 'Elige una ficha. Tu oponente revela si esta letra está en su Palabra Secreta.',
    cost: 2,
    type: 'vanilla'
  },
  {
    ...
    description: 'Tu oponente te indica la longitud exacta de su Palabra Secreta.',
    cost: 3,
    type: 'vanilla'
  },
  {
  ...
  // --- SPICY CARDS (El resto) ---
  {
    ...
    description: 'Tu oponente revela una ficha de Vocal en su Palabra Secreta que aún no haya sido revelada.',
    cost: 1,
    type: 'spicy'
  },
  {
    ...
    description: 'Tu oponente te indica el número de Vocales en su Palabra Secreta.',
    cost: 2,
    type: 'spicy'
  },
  {
    ...
    description: 'Tu oponente te indica el número de Consonantes en su Palabra Secreta.',
    cost: 3,
    type: 'spicy'
  },
  {
    ...
    name: 'Henery Hawk',
    flavor: 'Superjugada',
    description: 'Elige una letra. Si está, el oponente revela la posición de un solo ejemplar.',
    cost: 3,
    type: 'spicy'
  },
  {
  ...
  },
  {
    ...
    description: 'Elige una letra que tengas 2+ veces. Oponente dice cuántas veces aparece en su palabra.',
    cost: 2,
    type: 'spicy'
  },
  {
    ...
    name: 'Scuttle',
    flavor: 'Compartamos',
    description: 'Elige una letra presente en ambos sets. Se dice cuántas veces aparece en cada palabra.',
    cost: 1,
    type: 'spicy'
  },
  {
    ...
    name: 'Scrooge McDuck',
    flavor: 'Dinámico',
    description: 'Construye palabra. Oponente apaga las que no están. Coste = letras que quedan encendidas.',
    cost: 'variable',
    type: 'spicy'
  },
  {
...
export const BOT_WORDS = [
  ...
  'SOL', 'MAR', 'PAN', 'LUZ', 'VOZ', 'RED', 'FIN', 'SER', 'VER', 'DAR',
  'CASA', 'MESA', 'PISO', 'AGUA', 'AIRE', 'VIDA', 'AMOR', 'EDAD', 'ZONA', 'IDEA',
  'GATO', 'PERRO', 'SILLA', 'LAPIZ', 'RELOJ', 'CIELO', 'FUEGO', 'PLAYA', 'NOCHE', 'TARDE',
  
  // Palabras medianas (6-7 letras)
  'MANZANA', 'NARANJA', 'PLATANO', 'VENTANA', 'PUERTA', 'CAMINO', 'BOSQUE', 'CIUDAD',
  'LIBRO', 'MUNDO', 'FELIZ', 'GRANDE', 'VERDE', 'AZUL', 'NEGRO', 'BLANCO',
  'TIEMPO', 'ESPACIO', 'MUSICA', 'BAILE', 'JUEGO', 'DEPORTE', 'FIESTA', 'AMIGO',
  'PERSONA', 'FAMILIA', 'MADRE', 'PADRE', 'HERMANO', 'ESCUELA', 'TRABAJO', 'DINERO',
  
  // Palabras largas (8+ letras)
  'COMPUTADORA', 'TELEFONO', 'TELEVISION', 'INTERNET', 'DOCUMENTO', 'MEDICINA',
  'AVENTURA', 'HISTORIA', 'GEOGRAFIA', 'CIENCIA', 'UNIVERSO', 'PLANETA',
  
  // Palabras con Ñ
  'NIÑO', 'NIÑA', 'España', 'MONTAÑA', 'SUEÑO', 'MAÑANA', 'CABAÑA', 'PIÑA', 'AÑO', 'UÑA',
  'ENSEÑAR', 'DISEÑO', 'PEQUEÑO', 'TAMAÑO', 'BAÑO', 'SEÑOR', 'SEÑAL',
  
  // Palabras con vocales repetidas
  'CASA', 'MAMA', 'PAPA', 'TAZA', 'SALA', 'MAPA', 'LAVA', 'MASA',
  'BEBE', 'TELE', 'PELE', 'NENE', 'SEDE',
  'KILO', 'VINO', 'PINO', 'FILA', 'MINA', 'RISA', 'LISTA', 'PISTA', 'VISTA',
  'COCO', 'LOBO', 'TORO', 'BOCA', 'ROPA', 'COLA', 'COPA', 'HORA', 'SOPA',
  'TUBO', 'LUJO', 'ZUMO', 'MURO', 'PURO',
  
  // Variedad adicional
  'BERRY', 'LOBBY', 'CARTA', 'JUGAR', 'PASAR', 'LETRA', 'PALABRA', 'SECRETO',
  'RONDA', 'TURNO', 'PUNTO', 'FICHA', 'RIVAL', 'GANAR', 'PERDER',
  'ARBOL', 'FLOR', 'HOJA', 'RAMA', 'RAIZ', 'FRUTO', 'SEMILLA',
  'ESTRELLA', 'COMETA', 'SATELITE', 'COHETE', 'ESPACIO',
  'DRAGON', 'PRINCIPE', 'CASTILLO', 'CORONA', 'REINO', 'BATALLA',
  'OCEANO', 'VALLE', 'COLINA', 'DESIERTO', 'SELVA', 'PRADERA',
  'CALLE', 'AVENIDA', 'CARRETERA', 'PUENTE', 'EDIFICIO', 'TORRE',
  'COMIDA', 'CENA', 'ALMUERZO', 'POSTRE', 'HELADO', 'PASTEL',
  'MUSICA', 'CANCION', 'RITMO', 'MELODIA', 'ORQUESTA', 'GUITARRA',
  'PINTURA', 'ESCULTURA', 'ARTE', 'MUSEO', 'GALERIA', 'TEATRO'
];